...
(define-gauche-package "lineseg"
  ...
  ;; summary.
  :description "A module for handling line segments on the number line."
  ...
  ;; Homepage URL, if any.
  ; :homepage "http://example.com/lineseg/"

  ;; Repository URL, e.g. github
  :repository "https://github.com/Hamayama/lineseg"
  )
